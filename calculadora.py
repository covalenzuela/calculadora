...
class calculadora():
    def _init_(self):
        ...
        self.trans_matr.connect("clicked", self.multiplicacion_matrices)
        menu.show_all()
        ...
        def suma_matrices(self, btn=None):
            ...
            bf1c1 = self.f1c1.get_text()
            bf1c2 = self.f1c2.get_text()
            bf1c3 = self.f1c3.get_text()
            bf2c1 = self.f2c1.get_text()
            bf2c2 = self.f2c2.get_text()
            bf2c3 = self.f2c3.get_text()
            bf3c1 = self.f3c1.get_text()
            bf3c2 = self.f3c2.get_text()
            bf3c3 = self.f3c3.get_text()
            # Operacion Suma
            rf1c1 = af1c1 + bf1c1
            rf1c2 = af1c2 + bf1c2
            rf1c3 = af1c3 + bf1c3
